...
class AnimdoPage extends StatefulWidget {
  const AnimdoPage({Key? key}) : super(key: key);

  @override
  State<AnimdoPage> createState() => _AnimdoPageState();
}

class _AnimdoPageState extends State<AnimdoPage>
  ...
  Widget _circularAnimationButtion() {
    return Center(
